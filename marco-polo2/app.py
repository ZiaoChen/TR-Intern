...
bp = Blueprint('base_url', __name__, template_folder='templates')
...
def main():
    ...
    return render_template('template.html', companys_checked_indicator=companys_checked_indicator, company_list=company_list,
...
app = Flask(__name__, static_url_path='/marco-polo/static')
app.register_blueprint(bp, url_prefix='/marco-polo')
